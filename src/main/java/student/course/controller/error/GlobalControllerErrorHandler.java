package student.course.controller.error;
...
/**
 *  This is the global error handler class
 *  It is used to customize the exception message
 *  for specific exceptions like IllegalStateException
